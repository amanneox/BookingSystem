...
import com.api.api.model.AmazonAttachment;
import com.api.api.model.AmazonEmail;
    ...
    public void run() {
        try {
            ...
            sesClient = AmazonSimpleEmailServiceClientBuilder.standard()
                    ...
                    .withRegion(Regions.US_EAST_1) //TODO: make sure you've selected correct region
                    .build();
        } catch (Exception ex) {
        ...
        while (iCanContinue) {
            synchronized (queue) {
                ...
                if (queue.isEmpty()) {
                    ...
                    try {
                        //3 hours
                        int MAX_SLEEP_TIME = 3 * 60 * 60 * 1000;
